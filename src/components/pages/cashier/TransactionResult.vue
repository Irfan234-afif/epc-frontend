        ...
        <div class="bg-white rounded-3xl shadow-2xl p-10 max-w-lg w-full border border-gray-100">
          <div class="text-center">
            ...
            <button
              ...
              class="w-full bg-gray-800 text-white font-bold py-5 rounded-xl hover:bg-gray-900 transition-all duration-300 text-lg shadow-xl hover:shadow-2xl transform hover:scale-[1.02] active:scale-[0.98] animate-fade-in-up animation-delay-600"
            >
      ...
      <div v-else-if="transactionData && !success" class="min-h-[calc(100vh-12rem)] flex items-center justify-center animate-fade-in-scale">
        <div class="bg-white rounded-3xl shadow-2xl p-10 max-w-lg w-full border border-gray-100">
          <div class="text-center">
            ...
            <button
              @click="goBackToCashier"
              class="w-full bg-gray-800 text-white font-bold py-5 rounded-xl hover:bg-gray-900 transition-all duration-300 text-lg shadow-xl hover:shadow-2xl transform hover:scale-[1.02] active:scale-[0.98] animate-fade-in-up animation-delay-400"
            >
              Try Again
            </button>
          </div>
