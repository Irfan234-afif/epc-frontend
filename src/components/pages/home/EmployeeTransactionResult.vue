<template>
  <div class="min-h-screen bg-gradient-to-br from-emerald-300 via-green-400 to-teal-400 p-6 relative overflow-hidden">
    <!-- Animated Background Circles -->
    <div class="absolute top-0 left-0 w-[500px] h-[500px] bg-emerald-400/50 rounded-full blur-3xl animate-blob"></div>
    <div class="absolute top-0 right-0 w-[400px] h-[400px] bg-green-500/50 rounded-full blur-3xl animate-blob animation-delay-2000"></div>
    <div class="absolute bottom-0 left-1/2 w-[450px] h-[450px] bg-teal-500/50 rounded-full blur-3xl animate-blob animation-delay-4000"></div>
    
    <div class="max-w-2xl mx-auto relative z-10">
      <!-- Loading State -->
      <div v-if="isLoading" class="min-h-[calc(100vh-12rem)] flex items-center justify-center">
        <div class="glass-card rounded-3xl shadow-2xl p-10 max-w-lg w-full text-center">
      ...
      <div v-else-if="transactionData && success" class="min-h-[calc(100vh-12rem)] flex items-center justify-center animate-fade-in-scale">
        <div class="glass-card rounded-3xl shadow-2xl p-10 max-w-lg w-full">
