    ...
    <div class="p-6 mb-6">
      ...
      <div class="mt-4 flex justify-between">
        <router-link to="/purchase-history" class="text-center flex-1">
          <div class="text-center p-4">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 33 34" fill="none" class="w-8 h-8 mx-auto">
            ...
            <p class="text-xs font-semibold mt-4">History</p>
          </div>
        </router-link>
        <router-link to="/offers" class="text-center flex-1 disabled opacity-50 cursor-not-allowed pointer-events-none" @click.prevent>
          <div class="text-center p-4">
            <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 mx-auto">
        ...
        <router-link to="/stamps" class="text-center flex-1 disabled opacity-50 cursor-not-allowed pointer-events-none" @click.prevent>
          <div class="text-center p-4">
            <svg class="h-8 w-8 mx-auto" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="mt-4 space-y-2">
        <div class="flex justify-between items-center">
          <p class="text-lg font-semibold">Employee Updates</p>
        ...
        <div class="flex space-x-4 overflow-x-auto gap-2 py-4 px-6 -mx-6 scrollbar-hide">
          <router-link 
